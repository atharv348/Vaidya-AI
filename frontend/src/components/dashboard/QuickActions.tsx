...
import { Brain, ScanLine, MessageCircle, UtensilsCrossed, Pill, Accessibility, Zap } from "lucide-react";
...
const actions = [
  ...
  { icon: MessageCircle, label: "Health Coach", path: "/coach", color: "bg-success/10 text-success hover:bg-success/20" },
  { icon: UtensilsCrossed, label: "Plans", path: "/plans", color: "bg-warning/10 text-warning hover:bg-warning/20" },
