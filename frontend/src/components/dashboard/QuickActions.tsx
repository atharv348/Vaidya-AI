...
const actions = [
  ...
  { icon: Dumbbell, label: "Workout", path: "/workouts", color: "bg-coral/10 text-coral hover:bg-coral/20" },
  { icon: Utensils, label: "Meal Plan", path: "/meals", color: "bg-warning/10 text-warning hover:bg-warning/20" },
