  ...
  return (
    <div className="p-4 md:p-8 space-y-8 animate-in fade-in duration-500">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <div className="inline-flex items-center gap-3 px-4 py-2 rounded-2xl border border-primary/30 bg-gradient-to-r from-primary/15 via-primary/8 to-transparent shadow-lg shadow-primary/10 mb-3">
            <div className="w-9 h-9 rounded-xl gradient-primary text-primary-foreground flex items-center justify-center shadow-md shadow-primary/25">
